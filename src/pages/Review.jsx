            ...
            <div className="flex-1 flex flex-col justify-center items-center px-6 pt-10 max-w-2xl w-full mx-auto">
                ...
                <div className="w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10 mb-8">
                    ...
                    <button
                        ...
                        className="w-full bg-examly-accent hover:brightness-95 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-sm text-lg mt-4 flex justify-center items-center gap-2 cursor-pointer"
                    >
                        Launch Room
